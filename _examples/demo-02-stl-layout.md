...
description: "Compares four key-value container designs on two operations, run once unconstrained and once under a cgroup memory cap, to demonstrate how data layout determines cache behavior — the lesson §6 (STL & C++20/23 Containers) develops."
order: 2
layout: example
sectionid: examples
permalink: /examples/demo-02-stl-layout/
demo_dir: demo-02-stl-layout
