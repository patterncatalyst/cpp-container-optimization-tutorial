...
{% include excalidraw.html name="12-hermetic-build-flow" caption="The hermetic build flow: Conan lockfile + CMake preset + multi-stage Containerfile → labeled image" %}
